...
#cordova plugin add https://github.com/Wizcorp/cordova-facebook-plugin --variable APP_ID="411729638889643" --variable APP_NAME="Crunchbutton"
cordova plugin add https://github.com/arzynik/cordova-plugin-applepay --variable STRIPE_PUBLISHABLE_KEY="pk_test_O2GipEOkufCpgUJZaKP15OaQ" --variable APPLE_PAY_MERCHANT="merchant.com.crunchbutton"
cordova plugin add https://github.com/jeduan/cordova-plugin-facebook4 --variable APP_ID="411729638889643" --variable APP_NAME="Crunchbutton"
