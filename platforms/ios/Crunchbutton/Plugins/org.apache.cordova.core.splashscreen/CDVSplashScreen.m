...
- (void)updateBounds
{
	// @hack: temporay fix for ios7 splash screen
	int offset = ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7) ? 20 : 0;

    UIImage* img = _imageView.image;
    CGRect imgBounds = CGRectMake(0, offset, img.size.width, img.size.height);
